...
triggers: [writing, concise, documentation, "elements of style", editing, prose]
always: false
---

# Writing Clearly and Concisely

> **Provenance:** Vendored from [NeoLabHQ/context-engineering-kit](https://github.com/NeoLabHQ/context-engineering-kit/blob/master/plugins/docs/skills/write-concisely/SKILL.md) at commit `820f1db`. Unmodified except for this note and two added frontmatter lines (`triggers`, `always`) for Crew's skill scanner. The embedded *Elements of Style* (1918) text is public domain; the kit's own framing is GPL-3.0 — fine for this private repo, revisit before redistributing.
