...
- [x] [Awesome GitHub Copilot — Skills sorted by last updated](https://awesome-copilot.github.com/skills/?sort=lastUpdated) — **adopt**: Good maintenance-oriented companion to the main skills directory. — 🆕 **Added &lt;24h**
...
- [x] [avoid-ai-writing](https://www.claudepluginhub.com/plugins/wshobson-avoid-ai-writing-plugins-avoid-ai-writing) — **discard**: Writing-style tool is not a core repo need. — 🔴 **P1** · 🆕 **Added &lt;24h**
